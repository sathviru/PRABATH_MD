...
global.email = 'sathviru@gmail.com'
global.github = 'https://github.com/'
global.location = ''
global.gurl = 'https://instagram.com/sathviru_Rupasinghe' // add your username
global.devs = '94721489840';
global.website = 'https://github.com/' //wa.me/+94762280384
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/MClOeqe.jpeg'
module.exports = {
  OPENAI_API_KEY:process.env.OPENAI_API_KEY || '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',
  botname: process.env.BOT_NAME || 'Elisa-MD',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94721489840',
  alivepic: process.env.ALIVE_IMG || 'https://i.imgur.com/MClOeqe.jpeg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY Elisa-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'Sathviru',
